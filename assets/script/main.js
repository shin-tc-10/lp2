$(() =>  {
    ...
    $('.reviews__items').slick({
        ...
        infinite: true,
        speed: 500,
        prevArrow: '<img class="slick-prev reviews__arrow--left" src="assets/images/arrow_left_circle_fill_sp.svg">',
        nextArrow: '<img class="slick-next reviews__arrow--right" src="assets/images/arrow_right_circle_fill_sp.svg">',
        // ★ ページドットをカスタマイズ
    ...
    $dotsContainer.on('click', '.reviews__dot', function() {
        const index = $(this).index(); // ← クリックされたドットの番号を取得
